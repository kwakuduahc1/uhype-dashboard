...
#| cache: true
mod <- glm(
  formula =    financial_difficulties  ~ site + relationship + mbp___1 + mbp___3 + detained_12mths + relationship * mbp___1,
  family = binomial(),
  data = uhype
)  %>%
  tbl_regression(
...
eff_mod <- glmer(
  formula =    financial_difficulties  ~ relationship*mbp___1 + mbp___1 + mbp___3 + detained_12mths + (1 |site),
  data = uhype,
  family = binomial()
) %>% 
  tbl_regression(
...
We have shown the probable factors associated with financial distress for hypertensive patients seeking care in hospitals in Ghana. The findings in this paper agrees with previous publications that explored the cost of care for hypertensive patients in Ghana and in other parts of the world. Per our model, the visiting any hospital type did not affect the experience of financial difficulty by the study participants as the site of care was shown to be statistically not significant the generalized linear model and site as a random effect on the model also did not change the estimates nor their confidence interval and p values. They were all estimated to be close to each other. As such we can confidently say that the site of care has little to no effect on the cost of care for hypertensive patients. The presence of a partner as shown in our model significantly reduce financial distress, a phenomenon also observed in other studies @bogale_pcost_2020. The phenomenon is explainable by the increased access to funds by the patient, something that will not be available to a single person. Access and availability to a blood monitoring device as shown in our model was also observed by [@krakoff2019] to very cost effective besides it being as reliable as those checked in ambulatory settings. One study went as far as to encourage health insurance providers to reimburse facilities that provide home monitoring @pickering2008. Just as home monitoring, contacts with a pharmacist was shown to improve patient outcomes and even lower healthcare costs for hypertensive patients @jay_cost-effectiveness_2021. The interaction of the having a partner and a BP monitoring device at home showed an interesting observation. Independently, they both reduced the financial difficulties by the patients but participant who had a device at home and were married were more likely financially distressed than their counterparts. The interaction is very interesting and we have not found any study that has explored the interaction between the 2. A possible explanation that the cost of the device may have exposed the household to a catastrophic expenditure. To further confirm our suspicions, we tested the association between the having the device and being in a relation. The test was not statistically significant, `r inline_text(supp, col_level = "p.value")`. We are very curious about this association and we would explore this in the future as we equally encourage other researchers to take this up.

From our model, we observe an disturbing pattern of people who are able to afford some supplemental services are less likely to experience financial distress, given that they are already able to afford. Owning a home device or visiting pharmacy to check your BP involves some expenditure something lower-income families may be unable to afford. This would imply those that are already financially distressed are further burdened by the cost of care compared to their colleagues. 
